...
----
## RUNIT TEST PROTOCOL -- Mon Mar 19 09:05:57 2018 
## *********************************************** 
...
[source,r]
----
document::document(file.path("src", "wipe_clean.R"), output_directory = ".")
----
...
[source,r]
----
list.files(pattern = "^wipe.*", full.names = TRUE)
----

----
## [1] "./wipe_clean.html" "./wipe_clean.pdf"  "./wipe_clean.txt"
----
