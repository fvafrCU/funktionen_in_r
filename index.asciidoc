...
Du eigentlich auch gleich in einem oder mehreren Paketen verwalten. 
Das ist zwar am aufwendigsten, aber auch am elegantesten.
...
----
## RUNIT TEST PROTOCOL -- Wed Mar 21 10:24:44 2018 
## *********************************************** 
...
kannst Du mit dem Paket +document+ Du Hilfe-Dateien erstellen, 
...
----
## [1] "./golden_ratio.html"  "./golden_ratio.pdf"   "./golden_ratio.txt"  
## [4] "./golden_ratios.html" "./golden_ratios.pdf"  "./golden_ratios.txt"
----


Au&szlig;erdem kannst Du mit +document+ nach der Erstellung der Hilfe-Dateien 
...
Und zum Dritten und Wichtigsten: Du hast Deine Funktion dokumentiert und ihre Schnittstellen
beschrieben. Sie ist jetzt versandfertig:

==== Paketieren

Zum Paketieren nehmen wir wieder die getrennten Funktionsdateien, 
+src/golden_ratio.R+ und und +src/.golden_ratio.R+:
...
[source,r]
----
## Creating package 'mytools' in '/tmp'
...
[source,r]
----
## * Creating `mytools.Rproj` from template.
...
file.rename(file.path(package_dir, "R", ".golden_ratio.R"), 
            file.path(package_dir, "R", "_golden_ratio.R"))
----
...
[source,r]
----
## Updating roxygen version in /tmp/mytools/DESCRIPTION

----

----
## Writing NAMESPACE
## Writing golden_ratio.Rd
----
...
----
## ───────────────────────────────────────────────────────────────────────────
## ─  using log directory ‘/tmp/Rtmp09pQo4/file691a5a5e09b/mytools.Rcheck’
...
## ✔  checking whether package ‘mytools’ can be installed
...
##    golden_ratio: no visible global function definition for ‘.golden_ratio’
...
## E  checking examples
##    Running examples in ‘mytools-Ex.R’ failed
##    The error most likely occurred in:
##    
##    > base::assign(".ptime", proc.time(), pos = "CheckExEnv")
##    > ### Name: golden_ratio
##    > ### Title: Compute the Other Quantity in Golden Ratio
##    > ### Aliases: golden_ratio
##    > 
## ─  > ### ** Examples
##    > 
##    > print(golden_ratio(value = 1)[["a"]])
##    Error in golden_ratio(value = 1) : 
##      could not find function ".golden_ratio"
##    Calls: print -> golden_ratio
##    Execution halted
...
##             signalCondition(e)
##         }, "could not find function \".golden_ratio\"", quote(eval(expr, envir, enclos))) at testthat/test_golden_ratio.R:3
##      2: eval(expr, envir, enclos)
##      
##      testthat results ================================================================
##      OK: 0 SKIPPED: 0 FAILED: 2
##      1. Error: Test on Golden Ratio (@test_.golden_ratio.R#3) 
##      2. Error: Test on golden rectangle (@test_golden_ratio.R#3) 
##      
