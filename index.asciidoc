...
----
## RUNIT TEST PROTOCOL -- Mon Mar 19 11:23:47 2018 
## *********************************************** 
...
## 1: golden_ratio() at src/test_golden_ratio.R:3
...
[source,r]
----
list.files(pattern = "^golden_ratio*", full.names = TRUE)
----
...
Details:
     ...
     Specify ‘value = 1’ to obtain the Golden ratio in element "a" of
     the return value.
