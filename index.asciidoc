...
----
## RUNIT TEST PROTOCOL -- Mon Mar 19 12:16:42 2018 
## *********************************************** 
...
## 1: golden_ratio(value) at src/test_golden_ratio.R:3
...
[source,r]
----
## Error in golden_rectangle(width): could not find function "golden_ratio"
...
##        signalCondition(e)
##    }, "could not find function \"golden_ratio\"", quote(eval(expr, envir, enclos))) at src/test_golden_rectangle.R:3
...
Diese Funktionen lebt ja von Nebenwirkungen, sie ist schwer zu testen und wir hoffen also, dass Du keine Fehler gemachst hast.
...
[source,r]
----
# replace call to golden_ratio() in tests first!
...
Ob das funktioniert, testen wir nat&uuml;rlich:
...
## Error: Test failed: 'Test on golden rectangle'
## * unused argument (value)
## 1: .golden_ratio(value) at src/test_.golden_ratio.R:3
