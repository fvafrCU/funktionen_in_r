...
----
## RUNIT TEST PROTOCOL -- Fri Mar 23 16:10:49 2018 
## *********************************************** 
...
fragen (wobei https://CRAN.R-project.org/package=lintr[lintr] hier die vorhandene Funktion
        ...
        footnote::[Das ist ein altes Problem, siehe https://github.com/jimhester/lintr/issues/27. Wenn Du mit +devtools::install(".")+ das Paket installierst, verschwindet die falsch positive Warnung.] und https://CRAN.R-project.org/package=cyclocomp[cyclocomp] 
        ebenfalls nicht 
