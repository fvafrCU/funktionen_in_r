...
----
## RUNIT TEST PROTOCOL -- Thu Mar 15 17:13:53 2018 
## *********************************************** 
...
[source,r]
----
## Error: Test failed: 'Simple test golden ratio'
## * `result` not equal to `expectation`.
## 3/3 mismatches (average diff: 2.47)
## [1] 3.71 - 6.00 == -2.29
## [2] 2.29 - 3.71 == -1.42
## [3] 6.00 - 9.71 == -3.71
