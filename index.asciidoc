...
Du eigentlich auch gleich in einem oder mehreren Paketen verwalten, ist zwar am aufwendigsten, aber auch am elegantesten.
...
mit einer Funktion auswerten, bei +testthat+ ändert sich 
relativ wenig: 
...
.+RUnit+
Größer sind die Unterschiede bei +RUnit+, 
...
----
## RUNIT TEST PROTOCOL -- Fri Mar 16 21:05:27 2018 
## *********************************************** 
...
## Involved directory: 
## /home/nik/git/cyclops/fvafrcu/funktionen_in_r/src 
## --------------------------- 
## Test file: /home/nik/git/cyclops/fvafrcu/funktionen_in_r/src/runit_my_sum.R 
...
+covr+ ist eines der Pakete, die Code Coverage implentieren und das einzige, das ich nutze. Ich weiß es nicht, glaube aber, dass +covr+ die https://en.wikipedia.org/wiki/Code_coverage#Coverage_criteria[_branch coverage_]
berechnet. 
...
+golden_rectangle+ habe ich mir nur ausgedacht, um Dir mein Vorgehen zu verdeutlichen.
_Aber ich teste fast alle meine Funktion nach genau dem Ablauf in diesem Abschnitt spätestens, 
...
Wenn Du Hilfe zu einer Funktion in **R** suchst, kannst Du unter anderem die **R**-Hilfe mit +?functionsname+ aufrufen.
...
[source,r]
----
document::document(file.path("src", "wipe_clean.R"))
----
...
[source,r]
----
## Updating roxygen version in /tmp/RtmpkaGZ64/document_62d912befa84/wipe.clean/DESCRIPTION

----

[source,r]
----
## * using log directory ‘/tmp/RtmpkaGZ64/file62d9209658ce/wipe.clean.Rcheck’
## * using R Under development (unstable) (2017-08-15 r73096)
## * using platform: x86_64-pc-linux-gnu (64-bit)
## * using session charset: UTF-8
## * using option ‘--as-cran’
## * checking for file ‘wipe.clean/DESCRIPTION’ ... OK
## * checking extension type ... Package
## * this is package ‘wipe.clean’ version ‘2.0.0’
...
## * checking whether package ‘wipe.clean’ can be installed ... OK
...
----
## ###
## Got: * using log directory ‘/tmp/RtmpkaGZ64/file62d9209658ce/wipe.clean.Rcheck’
## * using R Under development (unstable) (2017-08-15 r73096)
## * using platform: x86_64-pc-linux-gnu (64-bit)
## * using session charset: UTF-8
## * using option ‘--as-cran’
...
## Status: 1 WARNING, 1 NOTE
## 
## /home/nik/svn/R/r-devel/build/library
## * using log directory ‘/tmp/RtmpkaGZ64/file62d9209658ce/wipe.clean.Rcheck’
## * using R Under development (unstable) (2017-08-15 r73096)
## * using platform: x86_64-pc-linux-gnu (64-bit)
## * using session charset: UTF-8
...
## Path: /tmp/RtmpkaGZ64/document_62d912befa84/wipe.clean
## ###
...
[source,r]
----
## Error in check_package(package_directory = package_directory, working_directory = working_directory, : R CMD check failed, read the above log and fix.
...
[source,r]
----
document::man("wipe_clean")
----

----
## _R_e_m_o_v_e _A_l_l _O_b_j_e_c_t_s _F_r_o_m _a_n _E_n_v_i_r_o_n_m_e_n_t
## 
...
## _U_s_a_g_e:
## 
##      wipe_clean(environment = parent.frame())
##      
## _A_r_g_u_m_e_n_t_s:
## 
## environment: The environment to be wiped.
## 
## _V_a_l_u_e:
## 
##      A character vector containing the names of objects removed.
----
