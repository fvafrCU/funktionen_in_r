...
----
## RUNIT TEST PROTOCOL -- Wed Mar 21 11:34:41 2018 
## *********************************************** 
...
## 2: code <- c(readLines("src/.golden_ratio.R"), "\n"
## 3:           readLines
##              ^
...
beschrieben. Sie ist jetzt paketierunsreif:
...
/tmp/mytools_0.1.0.tar.gz  ist jetzt versandfertig.
