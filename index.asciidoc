...
Stell Dir vor, Du h&auml;ttest in der Datei "src/code.R" folgende, unsch&ouml;ne Funktion programmiert:
//end_no_slide
...
----
## src/code.R:25:1: style: Trailing blank lines are superfluous.
## 
## ^
----
